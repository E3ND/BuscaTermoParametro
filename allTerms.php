    ...
    <body>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li> <a class="nav-link scrollto active " href="allTerms.php"> All terms </a></li>
        ...
        <section id="hero" class="d-flex align-items-center justify-content-center">
            ...
            <h1> All Terms </h1>
            <h2> All the technical terms you need to know on one page </h2>
            </div>
        </section>
    ...
    <?php 
        ...
        include("conexao.php");
            ...
            try{
                ...
                <center> <h3> Todos os termos </h3> </center>
